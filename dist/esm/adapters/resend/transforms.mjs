...
export function toAutosendRequest(resendOptions) {
...
export function mapHttpStatusToResendError(status, message) {
    const errorMap = {
...
export function toAutosendBulkRequest(resendOptions) {
