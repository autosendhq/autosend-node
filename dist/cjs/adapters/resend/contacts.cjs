...
exports.ContactsAdapter = void 0;
...
class ContactsAdapter {
    ...
    async get(_audienceId, id) {
        try {
            ...
            return {
                data: null,
                error: (0, transforms_js_1.mapHttpStatusToResendError)(404, response.error ?? "Contact not found"),
            };
        }
        catch (err) {
            return {
...
exports.ContactsAdapter = ContactsAdapter;
